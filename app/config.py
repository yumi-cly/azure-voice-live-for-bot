...
class Settings(BaseSettings):
    ...
    voice_live_asr_model: str = Field(default="azure-speech")
    voice_live_agent_model: str = Field(default="gpt-5.4")
    voice_live_tts_voice: str = Field(default="zh-CN-Xiaoxiao:DragonHDFlashLatestNeural")
    ...
    def resolved_voice_agent_name(self) -> str:
        return self.resolved_foundry_agent_name

    @property
    def resolved_voice_agent_version(self) -> str:
        return self.foundry_agent_version
